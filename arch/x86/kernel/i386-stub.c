...
extern void exceptionHandler(int x, void *a);	/* assign an exception handler   */

extern void write_serial(int p, char a);
...
*
*/
extern void __catchException3();
__asm__ (".text");
__asm__ (".globl __catchException3");
__asm__ ("__catchException3:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $3");
CALL_HOOK();
...
extern void __catchException1();
__asm__ (".text");
__asm__ (".globl __catchException1");
__asm__ ("__catchException1:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $1");
CALL_HOOK();
...
extern void __catchException0();
__asm__ (".text");
__asm__ (".globl __catchException0");
__asm__ ("__catchException0:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $0");
CALL_HOOK();
...
extern void __catchException4();
__asm__ (".text");
__asm__ (".globl __catchException4");
__asm__ ("__catchException4:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $4");
CALL_HOOK();
...
extern void __catchException5();
__asm__ (".text");
__asm__ (".globl __catchException5");
__asm__ ("__catchException5:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $5");
CALL_HOOK();
...
extern void __catchException6();
__asm__ (".text");
__asm__ (".globl __catchException6");
__asm__ ("__catchException6:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $6");
CALL_HOOK();
...
extern void __catchException7();
__asm__ (".text");
__asm__ (".globl __catchException7");
__asm__ ("__catchException7:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $7");
CALL_HOOK();
...
extern void __catchException8();
__asm__ (".text");
__asm__ (".globl __catchException8");
__asm__ ("__catchException8:");
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
__asm__  ("pushl $8");
...
extern void __catchException9();
__asm__ (".text");
__asm__ (".globl __catchException9");
__asm__ ("__catchException9:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $9");
CALL_HOOK();
...
extern void __catchException10();
__asm__ (".text");
__asm__ (".globl __catchException10");
__asm__ ("__catchException10:");
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
__asm__  ("pushl $10");
...
extern void __catchException12();
__asm__ (".text");
__asm__ (".globl __catchException12");
__asm__ ("__catchException12:");
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
__asm__  ("pushl $12");
...
extern void __catchException16();
__asm__ (".text");
__asm__ (".globl __catchException16");
__asm__ ("__catchException16:");
SAVE_REGISTERS1();
SAVE_REGISTERS2();
__asm__  ("pushl $16");
CALL_HOOK();
...
extern void __catchException13 ();
__asm__  (".text");
__asm__  (".globl __catchException13");
__asm__  ("__catchException13:");
CHECK_FAULT();
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
...
extern void __catchException11 ();
__asm__  (".text");
__asm__  (".globl __catchException11");
__asm__  ("__catchException11:");
CHECK_FAULT();
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
...
extern void __catchException14 ();
__asm__  (".text");
__asm__  (".globl __catchException14");
__asm__  ("__catchException14:");
CHECK_FAULT();
SAVE_REGISTERS1();
SAVE_ERRCODE();
SAVE_REGISTERS2();
	...
	while (1)
	{
		...
		if (ch == '#')
		{
			...
			if (checksum != xmitcsum)
			{
				if (remote_debug)
				{
					printk_safe(6, "bad checksum.  My count = 0x%x, sent=0x%x. buf=%s\n",
...
handle_exception (int exceptionVector)
{
	...
	if(exceptionVector == 3)
		printk_safe(6, "---[DEBUG - breakpoint]---\n");
	gdb_i386vector = exceptionVector;

	if (remote_debug)
	{
		printk_safe(6, "vector=%d, sr=0x%x, pc=0x%x\n",
...
set_debug_traps (void)
{
	...
	exceptionHandler (0, __catchException0);
	exceptionHandler (1, __catchException1);
	exceptionHandler (3, __catchException3);
	exceptionHandler (4, __catchException4);
	exceptionHandler (5, __catchException5);
	exceptionHandler (6, __catchException6);
	exceptionHandler (7, __catchException7);
	exceptionHandler (8, __catchException8);
	exceptionHandler (9, __catchException9);
	exceptionHandler (10, __catchException10);
	exceptionHandler (11, __catchException11);
	exceptionHandler (12, __catchException12);
	exceptionHandler (13, __catchException13);
	exceptionHandler (14, __catchException14);
	exceptionHandler (16, __catchException16);

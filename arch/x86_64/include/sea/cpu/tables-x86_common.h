...
void write_tss(gdt_entry_t *, tss_entry_t *, int32_t num, uint16_t ss0, addr_t esp0);
void gdt_set_gate(gdt_entry_t *, int32_t,uint32_t,uint32_t,uint8_t,uint8_t);
void idt_set_gate(uint8_t,addr_t,uint16_t,uint8_t);
